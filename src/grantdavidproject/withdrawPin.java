 ...
 * @author david
 */
public class withdrawPin extends javax.swing.JFrame {

    private Checking checking;
    private Savings savings;

    /**
     * Creates new form withdrawPin
     */

    withdrawPin(Checking checking, Savings savings) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (inputPin == checking.getPin() || inputPin == savings.getPin()) {
            Withdraw withdrawFrame = new Withdraw(checking, savings);
